...
public abstract class TelaL_1_Login extends JFrame implements ActionListener{
    ...
    JLabel NomeSistema = new JLabel("SISTEMA DE GESTÃO DE PACIENTES NO PLANEAMENTO FAMILIAR");
   ...
   // JButton info= new JButton("Click  aqui para  Informações sobre Planeamento Familiar");
    ...
    JCheckBox show = new JCheckBox("Exibir",new ImageIcon(getClass().getResource("/Imagens/show.png")));
...
//    add(info);
  ...
  //  info.setBounds(0,666,1600,50);
    ...
    FundoLogin.setIcon(new ImageIcon(getClass().getResource("/Imagens/fundo1.jpg")));
          ...
          if(ae.getSource()==gerir){
            ...
            if((!nome.isEmpty())&&(!senha.isEmpty())){
                if((nome.equalsIgnoreCase("admin"))&&(senha.equalsIgnoreCase("admin"))){
                    ...
                    JOptionPane.showMessageDialog(null,"USUARIO OU CODIGO INCORRECTO\n","Informação", JOptionPane.ERROR_MESSAGE);
                }
